            ...
            >
              ...
              >
                <image
                  class="header_icon"
                  v-if="isWhite"
                  src="@/static/images/navbar/icon_back_white.png"
                  mode="aspectFit"
                ></image>
                <image
                  class="header_icon"
                  v-else
                  src="@/static/images/navbar/icon_back_black.png"
                  mode="aspectFit"
                ></image>
              </view>
              <text
              ...
              >
                <image
                  class="header_icon"
                  v-if="isWhite"
                  src="@/static/images/navbar/icon_home_white.png"
                  mode="aspectFit"
                ></image>
                <image
                  class="header_icon"
                  v-else
                  src="@/static/images/navbar/icon_home_black.png"
                  mode="aspectFit"
                ></image>
              </view>
            </view>
...
const mainPagePath = ['pages/home/home', 'pages/index/index', 'pages/demo/common', 'pages/template/common', 'pages/apiDemo/common'];
//返回首页的地址
