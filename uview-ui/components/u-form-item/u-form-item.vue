        ...
        <view class="u-form-item__body"
            ...
            <view class="u-form-item--left"
                ...
                <view class="u-form-item--left__content"
                    ...
                    <!-- nvue不支持伪元素before -->
                    <text v-if="required"
                          class="u-form-item--left__content--required">*</text>
                    <view class="u-form-item--left__content__icon"
                          v-if="leftIcon">
                        <u-icon :name="leftIcon"
                                :custom-style="leftIconStyle"></u-icon>
                    </view>
            ...
            <view class="u-form-item--right u-flex">
                <view class="u-form-item--right__content">
                    ...
                    <view class="u-form-item--right__content__icon u-flex"
                          v-if="$slots.right || rightIcon">
                        <u-icon :custom-style="rightIconStyle"
                                v-if="rightIcon"
                                :name="rightIcon"></u-icon>
                        <slot name="right" />
                    </view>
                </view>
            </view>
        </view>
        <view class="u-form-item__message"
